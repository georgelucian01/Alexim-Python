...
def scrape_product_info(product_page_link, parent_category, category, driver):
...
def scrape_category_page(site, parent_category, driver):
    ...
    for article in article_blocks:
        ...
        if product_page_link:
            ...
            scrape_product_info(product_page_link, parent_category, category, driver)
...
def main():
    ...
    for category in result:
        ...
        for subcategory in category['subcategories']:
            ...
            scrape_category_page(subcategory['url'], category['parent_category'], driver )
